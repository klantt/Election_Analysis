...
file_to_load = os.path.join('C:/Users/Gbay_/Desktop/Class/Election_Analysis/Resources/election_results.csv')
# Add a variable to save the file to a path.
file_to_save = os.path.join('C:/Users/Gbay_/Desktop/Class/Election_Analysis/Resources/election_analysist.txt')
